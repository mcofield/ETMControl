...
public:
    ...
    void setupUi(QMainWindow *Login)
    {
        ...
        groupBox->setGeometry(QRect(420, 90, 321, 201));
        ...
        label_logo->setGeometry(QRect(30, 110, 311, 181));
        label = new QLabel(centralWidget);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(280, 10, 251, 61));
        QFont font;
    ...
    void retranslateUi(QMainWindow *Login)
    {
        ...
        action_closeProgram->setText(QApplication::translate("Login", "Close Program", Q_NULLPTR));
        action_switchUser->setText(QApplication::translate("Login", "Switch User", Q_NULLPTR));
        action_userManual->setText(QApplication::translate("Login", "User Manual", Q_NULLPTR));
        ...
        label_password->setText(QApplication::translate("Login", "Password:", Q_NULLPTR));
        pushButton_login->setText(QApplication::translate("Login", "Login", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("Login", "Shut Down", Q_NULLPTR));
        label_logo->setText(QString());
        label->setText(QApplication::translate("Login", "<html><head/><body><p><span style=\" font-size:36pt; font-weight:600; color:#ff0000;\">ETM Login</span></p></body></html>", Q_NULLPTR));
        menuFile->setTitle(QApplication::translate("Login", "File", Q_NULLPTR));
        menuHelp->setTitle(QApplication::translate("Login", "Help", Q_NULLPTR));
        menuExit->setTitle(QApplication::translate("Login", "Exit", Q_NULLPTR));
    } // retranslateUi
